...
export interface DashboardDay{date:string;dayType:'WORKDAY'|'WEEKEND'|'HOLIDAY';holidayName:string|null;schedulable:boolean}
export interface Dashboard{month:string;employees:EmployeeStat[];assignments:Assignment[];days:DashboardDay[]}
