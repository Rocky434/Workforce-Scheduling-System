...
public interface ScheduleEntryRepository extends JpaRepository<ScheduleEntry, Long> {
        ...
        List<ScheduleEntry> findEmployeeMonth(@Param("employeeId") Long employeeId, @Param("start") LocalDate start,
        ...
        @Modifying
        @Query("delete from ScheduleEntry e where e.employee.id=:employeeId and e.calendarDay.date between :start and :end")
        void deleteEmployeeMonth(@Param("employeeId") Long employeeId, @Param("start") LocalDate start,
                        @Param("end") LocalDate end);
}
